<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.valueId" clearable class="filter-item" style="width: 200px;" placeholder="请输入雇员ID" />
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="疯狂加载中" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="雇员ID" prop="valueId" />
